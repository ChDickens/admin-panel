        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="pageTitle" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="Заголовок поста" value="">
                    @if ($errors->has('name'))
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <input type="text" name="url" id="pageUrl" class="form-control {{ $errors->has('url') ? ' is-invalid' : '' }}" placeholder="Url поста" value="">
                    @if ($errors->has('url'))
                        <div class="invalid-feedback">
                            {{ $errors->first('url') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="seo_title" id="pageSeoTitle" class="form-control {{ $errors->has('seo_title') ? ' is-invalid' : '' }}" placeholder="Тайтл поста" value="">
